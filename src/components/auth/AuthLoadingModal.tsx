...
export default function AuthLoadingModal({ message }: AuthLoadingModalProps) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#071c10]/40 backdrop-blur-sm p-4">
      <div className="bg-white border border-[#d8e1da] rounded-md shadow-xl max-w-xs w-full p-6 flex flex-col items-center justify-center space-y-4 animate-in fade-in zoom-in duration-200">
